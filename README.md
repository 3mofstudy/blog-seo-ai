...
每個模型預設會產生三則切入角度不同的摘要，寫成[方格子沙龍](https://vocus.cc/salon/lucy-r)列表會出現的文章介紹，而不是三句換句話說：

1. 系列或文章定位：這篇在解決什麼、會介紹什麼
2. 讀者痛點開場：如果你／為什麼，再接到本文帶你做什麼
3. 主題、適用對象與涵蓋範圍

字數預設要求落在 100 到 150 個字元之間，含中文字、標點與空白，以 Python `len()`
